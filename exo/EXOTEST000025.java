import java.util.Scanner;
     ...
     //Un magasin proposant un service de Réprographie facture 0.10€ les 10 premières photocopies,
     // 0.09€ les vingt suivants et 0.08 au delà.

    //Écrire l’algorithme qui demande à l’utilisateur de saisir le nombre de photocopies effectuées 
    //et affiche le montant de la facture correspondante.
